const client = io.connect("https://call-video-rtc.herokuapp.com:35317", {secure: true});
...
// var peer = new Peer({host:'call-video-rtc.herokuapp.com', secure:true, port:35317});
var peer = new Peer();
peer.on('open', id => {
