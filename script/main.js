const client = io.connect("https://call-video-rtc.herokuapp.com:30593", {secure: true});
...
var peer = new Peer({host:'call-video-rtc.herokuapp.com', secure:true, port:30593});
// var peer = new Peer();
peer.on('open', id => {
