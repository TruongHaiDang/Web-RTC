const client = io.connect("https://call-video-rtc.herokuapp.com:23123", {secure: true});
...
// var peer = new Peer({host:'call-video-rtc.herokuapp.com', secure:true, port:23123});
// var peer = new Peer();
peer.on('open', id => {
