const client = io('https://git.heroku.com/stream-video-rtc.git:443');
...
var peer = new Peer({key: 'peerjs', host: 'https://stream-video-rtc.herokuapp.com', secure: true, port: 443});
// var peer = new Peer();
peer.on('open', id => {
